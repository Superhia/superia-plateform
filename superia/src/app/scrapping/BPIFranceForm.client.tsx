...
export default function BPIFranceForm() {
  ...
  const handleSubmit = async () => {
    ...
    return (
      ...
      <button className="p-5 px-32 m-5" onClick={handleSubmit}>
        <img src="Logo_Bpifrance.svg.png" alt="logo BPI France" className="h-8 w-24 mx-auto" />
        https://talents.bpifrance.fr/
      </button>
