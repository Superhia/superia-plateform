...
export default function Chatpdf() {
  ...
  return (
    ...
    <p className="text-center mx-32 px-32">Unique en son genre, notre fonctionnalité d'analyse de sentiments de vos vidéos youtube permet une interaction directe. Obtenez des résumés et discutez avec le contenu de vos PDFs comme jamais auparavant.</p>
