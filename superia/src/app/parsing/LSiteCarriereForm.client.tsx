...
import FileUploadComponent, { FileUploadComponentRef } from './LSiteCarriereComponent.client';
...
const EbookClientComponent = () => {
  ...
  return (
    <div>
      ...
      >
        <img src="livre_sitecarriere_10_GV.pdf" alt="Ebook Experience Candidat" className="h-32 w-24 mx-auto" />
        Livre Site Carrière
      </button>
