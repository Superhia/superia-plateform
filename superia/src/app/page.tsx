...
export default function Home() {
  return (
    ...
    <p className="text-center py-2.5 mx-32 px-32">"La première application qui utiliser l'IA générative pour l'analyse de marque employeur. Grâce à Superia, vous pouvez désormais exploiter pleinement le potentiel de votre site carrière, en analysant et optimisant leur contenu pour attirer les meilleurs talents."</p>
