...
export default function Sentimentpage() {
  ...
  return (
    ...
    <h1 className="text-4xl font-semibold text-center py-7">Analyse de sentiment des entreprises</h1>
    <p className="text-center py-2.5 mx-32 px-32">Avec SuperIA, vous pouvez obtenir des insights précieux sur l'opinion de vos employés. Notre technologie d'intelligence artificielle générative analyse les feedbacks, les conversations, et les commentaires au sein de votre entreprise pour vous offrir une vision claire et détaillée de ce que vos équipes ressentent. Que ce soit pour améliorer le climat de travail, ajuster votre stratégie managériale, ou simplement pour rester à l'écoute, SuperIA vous permet de comprendre l'état d'esprit de vos collaborateurs et d'agir en conséquence.</p>
